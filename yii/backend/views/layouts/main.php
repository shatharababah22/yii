            ...
            <div class="card">
              ...
              <div class="card-body-height">
                ...
                <a class="dropdown-item" href="./index.html">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="avatar avatar-xs avatar-circle" src="<?= Url::to('@web/img/160x160/img10.jpg') ?>" alt="Image DeScription">
                    </div>
                    <div class="flex-grow-1 text-truncate ms-2">
                ...
                <a class="dropdown-item" href="./index.html">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="avatar avatar-xs avatar-circle" src="<?= Url::to('@web/img/160x160/img3.jpg') ?>" alt="Image DeScription">
                    </div>
                    <div class="flex-grow-1 text-truncate ms-2">
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <img class="avatar avatar-sm avatar-circle" src="<?= Url::to('@web/img/160x160/img3.jpg') ?>" alt="Image DeScription">
                                </div>
                              </div>
                              <!-- End Col -->
                              ...
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="<?= Url::to('@web/img/160x160/img10.jpg') ?>" alt="Image DeScription">
                                  </div>
                                </div>
                              </div>
                              <!-- End Col -->
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="<?= Url::to('@web/img/160x160/img7.jpg') ?>" alt="Image DeScription">
                                  </div>
                                </div>
                              </div>
                              <!-- End Col -->
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="<?= Url::to('@web/img/160x160/img5.jpg') ?>" alt="Image DeScription">
                                  </div>
                                </div>
                              </div>
                              <!-- End Col -->
                ...
                <div class="card">
                  ...
                  <div class="card-body card-body-height">
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="<?= Url::to('@web/svg/brands/atlassian-icon.svg') ?>" alt="Image DeScription">
                        </div>
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="<?= Url::to('@web/svg/brands/slack-icon.svg') ?>" alt="Image DeScription">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-3">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="<?= Url::to('@web/svg/brands/google-webdev-icon.svg') ?>" alt="Image DeScription">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-3">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="<?= Url::to('@web/svg/brands/frontapp-icon.svg') ?>" alt="Image DeScription">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-3">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="<?= Url::to('@web/svg/illustrations/review-rating-shield.svg') ?>" alt="Image DeScription">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-3">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              <a class="navbar-dropdown-account-wrapper" href="javaScript:;" id="accountNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-dropdown-animation>
                <div class="avatar avatar-sm avatar-circle">
                  <img class="avatar-img" src="<?= Url::to('@web/img/160x160/img6.jpg') ?>" alt="Image DeScription">
    ...
    <div class="navbar-vertical-container">
      <div class="navbar-vertical-footer-offset">
        ...
        <a class="navbar-brand" href="./index.html" aria-label="Front">
          ...
          <img class="navbar-brand-logo" src="<?= Url::to('@web/svg/logos-light/logo.svg') ?>" alt="Logo" data-hs-theme-appearance="dark">
          <img class="navbar-brand-logo-mini" src="<?= Url::to('@web/svg/logos/logo-short.svg') ?>" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo-mini" src="<?= Url::to('@web/svg/logos/logo-short.svg') ?>" alt="Logo" data-hs-theme-appearance="dark">
        </a>
            ...
            <li class="navbar-vertical-footer-list-item">
              ...
              <div class="dropdown dropup">
                <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle" id="selectLanguageDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                  <img class="avatar avatar-xss avatar-circle"  src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/us.svg') ?>" alt="United States Flag">
                </button>
               "
                <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectLanguageDropdown">
                  <span class="dropdown-header">Select language</span>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2"  src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/us.svg') ?>" alt="Flag">
                    <span class="text-truncate" title="English">English (US)</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/gb.svg') ?>" alt="Flag">
                    <span class="text-truncate" title="English">English (UK)</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/de.svg') ?>" alt="Flag">
                    <span class="text-truncate" title="Deutsch">Deutsch</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/dk.svg') ?>" alt="Flag">
                    <span class="text-truncate" title="Dansk">Dansk</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/it.svg') ?>" alt="Flag">
                    <span class="text-truncate" title="Italiano">Italiano</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="<?= Url::to('@web/vendor/flag-icon-css/flags/1x1/cn.svg') ?>" alt="Flag">
