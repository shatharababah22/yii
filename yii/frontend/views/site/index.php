                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="scheduleEmailInput" class="form-label">Pax Type<span class="text-danger">*</span></label>

                                    <?= $form->field($model, 'pax_type')->dropDownList([
                                        '' => 'Pax Type',
                                        '75-86' => 'Adult 75-86 Years',
                                        '19-75' => 'Adult 19-75 Years',
                                        '2-18' => 'Child 02-18 Years',
                                    ], ['id' => 'pax-type-dropdown', 'class' => 'form-control'])->label(false) ?>
                                ...
                                <div id="fields-container">
                                    <div id="adult1" class="field-group col-12" style="display:none;">
                                        <label for="scheduleEmailInput" class="form-label">Adult<span class="text-danger">*</span></label>
                                        <?= $form->field($model, 'adult')->dropDownList(range(0, 50), ['class' => 'form-control'])->label(false) ?>
                                    </div>
                                    <div id="adult" class="row" style="display:none;">
                                        <div class="field-group col-md-6 col-12">
                                            <label for="scheduleEmailInput" class="form-label">Adult<span class="text-danger">*</span></label>
                                            <?= $form->field($model, 'adult')->dropDownList(range(0, 50), ['class' => 'form-control'])->label(false) ?>
                                        </div>
                                        <div id="infant" class="field-group col-md-6 col-12" style="display:none;">
                                            <label for="scheduleEmailInput" class="form-label">Infant</label><span class="text-danger">*</span></label>
                                    ...
                                    <div id="child" class="field-group col-12" style="display:none;">
                                        <label for="scheduleEmailInput" class="form-label">Child</label><span class="text-danger">*</span></label>
