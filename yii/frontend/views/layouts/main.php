    ...
    <header>
        <nav class="navbar navbar-expand-lg  transparent navbar-transparent navbar-dark">
            <div class="container px-3">
                <a class="navbar-brand" href="/insurances"><img class="img-fluid" width="70" src="/images/logo/logo-dark.png" alt /></a>
                <button class="navbar-toggler offcanvas-nav-btn" type="button">
                    <i class="bi bi-list"></i>
                </button>
                <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                    <div class="offcanvas-header">
                        <a href="/insurances" class="text-inverse"><img class="img-fluid" width="70" src="/images/logo/logo-dark.png" alt /></a>
                    ...
                    <div class="offcanvas-body pt-0 align-items-center">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php foreach ($countries as $country) : ?>
                                        <li>
                                            ...
                                            <?= Html::a(Yii::t('app', $country->source_country), ['/insurance/type', 'slug' => $country->slug], ['class' => 'dropdown-item', 'data-cue' => 'fadeUp']) ?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php foreach (\common\models\Insurances::find()->all() as $insurance) : ?>
                                        <li>
                                            <?= Html::a(Yii::t('app', $insurance->name), ['/insurance/programs', 'slug' => $insurance->slug], ['class' => 'dropdown-item', 'data-cue' => 'fadeUp']) ?>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                        ...
                        <div class="mt-3 mt-lg-0 d-flex align-items-center">
                            <a href="/insurances" class="btn btn-light mx-2">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="collapse d-lg-block" id="collapseLanding" data-bs-parent="#ft-links">
                                    <ul class="list-unstyled mb-0 py-3 py-lg-0">
                                        <?php foreach (\common\models\Insurances::find()->limit(6)->all() as $insurance) : ?>
                                            <li class="mb-2">
                                                <?= Html::a(Yii::t('app', $insurance->name), ['/insurance/programs', 'slug' => $insurance->slug], ['class' => 'text-decoration-none', 'style' => 'color:#64748B;']) ?>
