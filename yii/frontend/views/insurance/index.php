                ...
                <div class="table-responsive">
                    <table class="table table-striped text-nowrap table-lg table-borderless">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($plansItemsTitles as $planId => $planItems) : ?>
                                <?php foreach ($planItems as $plansItem) : ?>
                                    <tr class="clickable-row" data-index="<?= $planId ?>">
                                        <td>
                                            <?= $plansItem['title'] ?>
                                        </td>
                                        <?php foreach ($planCoverageItems as $planCoverageItemss) : ?>
                                            <?php foreach ($planCoverageItemss as $planCoverageItem) : ?>
                                                <td>
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        </span><?= $planCoverageItem['description'] ?></span>
                                                    <?php endif; ?>
                                                </td>
